...
<div class="so2_home">
  ...
  <div class="so2-description z_l">
    <p class="z_b">SO2DESIGN est un studio de design graphique basé à Genève, en Suisse. Spécialisé dans la création de structures d'identité visuelle qui facilitent la communication par le biais des stratégies de conception audacieuses, il travaille avec un large éventail de clients…</p>
...
<!--					    <header class="article-header">
						    ...
						    <section class="post-content clearfix">
							    ...
							    <a href="<?php the_permalink() ?>" rel="bookmark"> <?php the_post_thumbnail('bones-thumb-big'); ?> </a>
